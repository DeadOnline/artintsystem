...
// ARTINTSYSTEMAPPLICATION construction
...
// The one and only ARTINTSYSTEMAPPLICATION object

ARTINTSYSTEMAPPLICATION theApp;


// ARTINTSYSTEMAPPLICATION initialization
...
BOOL ARTINTSYSTEMAPPLICATION::InitInstance()
{
	...
	ARTINTSYSTEMDIALOG dlg(this, NULL);
	m_pMainWnd = &dlg;
